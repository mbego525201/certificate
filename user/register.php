...
if(isset($_POST['submit']))
  {
    ...
    $ret="select MobileNumber from tbluser where MobileNumber=:mobno OR username=:username";
...
if($query -> rowCount() == 0)
{
$sql="Insert Into tbluser(FirstName,LastName, username, MobileNumber,Address,Password)Values(:fname,:lname,:username, :mobno,:add,:password)";
...
echo "<script>alert('This Mobile Number Or username already exist. Please try again');</script>";
}
}
