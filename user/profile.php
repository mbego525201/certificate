...
if (strlen($_SESSION['obcsuid']==0)) {
  ...
  $add=$_POST['add'];
  $sql="update tbluser set FirstName=:fname,LastName=:lname, MobileNumber=:mobile, Address=:add where ID=:uid";
...
{               ?>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <input type="text" class="form-control" name="mobile" value="<?php  echo $row->MobileNumber;?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="form-group-inner">
