...
INSERT INTO `tbluser` (`ID`, `username`, `FirstName`, `LastName`, `MobileNumber`, `Address`, `Password`, `RegDate`) VALUES
(1, 'user1', 'Himanshu', 'MIshra', 7987897897, 'J&K Block Laxmi Nagar New Delhi', '5c428d8875d2948607f3e3fe134d71b4', '2020-02-11 11:26:29'),
(2, 'user2', 'Meera', 'Jain', 8797977797, 'U-890 VVIP Ghazibad', '5c428d8875d2948607f3e3fe134d71b4', '2020-02-11 11:27:35'),
(3,  'user3', 'Kunal', 'Kumar', 9754774987, 'K-123, Nangloi New Delhi', '5c428d8875d2948607f3e3fe134d71b4', '2020-02-19 16:49:03');
...
--
CREATE TABLE `tblmarriageregistration` (
  `ID` int(10) NOT NULL,
  ...
  `HusbandIDNO` varchar(200) DEFAULT NULL,
  ...
  `WifeIDNO` varchar(200) DEFAULT NULL,
...
INSERT INTO `tblmarriageregistration` (`ID`, `RegistrationNumber`, `UserID`, `DateofMarriage`, `HusbandName`, `HusImage`, `HusbandReligion`, `Husbanddob`, `HusbandSBM`, `HusbandAdd`, `HusbandZipcode`, `HusbandState`, `HusbandIDNO`, `WifeName`, `WifeImage`, `WifeReligion`, `Wifedob`, `WifeSBM`, `WifeAdd`, `WifeZipcode`, `WifeState`, `WifeIDNO`, `WitnessNamefirst`, `WitnessAddressFirst`, `WitnessNamesec`, `WitnessAddresssec`, `WitnessNamethird`, `WitnessAddressthird`, `RegDate`, `Status`, `Remark`, `UpdationDate`) VALUES
...
ALTER TABLE `tblmarriageregistration`
  MODIFY `ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- Indexes for table `tblmarriageregistration`
--
ALTER TABLE `tblmarriageregistration`
  ADD PRIMARY KEY (`ID`);
